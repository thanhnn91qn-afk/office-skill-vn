...
> **office-skill-vn:** Đây là tài liệu tham chiếu đầy đủ. Lệnh kiểu `extract-text`, `python scripts/thumbnail.py`, `scripts/office/unpack.py`, `editing.md` có thể **chưa có** trong repo skill này — xem [README.md](README.md) trong cùng thư mục. Tạo slide mới: [pptxgenjs.md](pptxgenjs.md).
